...
export class Renderer {
    ...
    protected projMatrix: THREE.Matrix4;
    ...
    protected getPerspective() {
        ...
        projMatrix.makePerspective(-fieldOfView / 2, fieldOfView / 2, -fieldOfView / 2 / aspect, fieldOfView / 2 / aspect, 0.1, 500.0);
        return projMatrix;
    }
    ...
    protected setUniform(name: string, value: number[] | Float32Array) {
    ...
    protected prepareDraw(viewMatrix: THREE.Matrix4) {
        this.setUniform("mView", viewMatrix.toArray());
        this.setUniform("mProj", this.projMatrix.toArray());
