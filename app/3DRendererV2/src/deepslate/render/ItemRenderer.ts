...
export class ItemRenderer extends Renderer {
    ...
    constructor(gl: WebGLRenderingContext, private item: ItemStack, private readonly resources: ItemRendererResources, context: ItemRenderingContext = {}) {
        super(gl);
    ...
    protected override getPerspective() {
        ...
        // WARNING: May be a source of a bug because parameters were changed from `0, 16, 0, 16, 0.1, 500.0` to `0, 16, 16, 0, 0.1, 500.0`.
        projMatrix.makeOrthographic(0, 16, 16, 0, 0.1, 500.0);
        return projMatrix;
    }

    public drawItem() {
        const view = new THREE.Matrix4();
        view.makeTranslation(0, 0, -32);
